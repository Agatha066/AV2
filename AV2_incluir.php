...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if ($formInvalido == 0) {
        ...
        //fazendo conexao com o banco
			...
			{
				//imprimindo do banco
				$sql = "INSERT INTO produto (ID_PROD,NOME,CATEGORIA,TIPO,FABRICANTE,COD_BARRA,IMG,DESCRICAO,PRECO,PESO,QUANT_EST,DISPONIVEL,DATA_CADASTRO) 
				VALUES ($id,'$nome','$categoria','$tipo','$fabricante','$cod','$nome_imagem','$descricao',$preco,$peso,$quant,$disponivel,'$data')";
